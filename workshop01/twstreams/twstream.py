...
class StdOutListener(StreamListener):
    ...
    def processTweet(self, obj):
        ...
        try:
            ...
            content = 'INSERT INTO tweets (id, created_at, text, source, lang, user_id, user_name, user_screenname, user_description, retweet_count, favorite_count, followers_count, friends_count, statuses_count, user_location, user_verified, placename, placetype, lng, lat) VALUES (%s, "%s", "%s", "%s", "%s", %s, "%s", "%s", "%s", %s, %s, %s, %s, %s, "%s", "%s", "%s", "%s", %s, %s)'% (tid, created_at, text, source, lang, user_id, user_name, user_screenname, user_description, retweet_count, favorite_count, followers_count, friends_count, statuses_count, user_location, user_verified, placename, placetype, lng, lat)
        except:
            content = ''
        return content
